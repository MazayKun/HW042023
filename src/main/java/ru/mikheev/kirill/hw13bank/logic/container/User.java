...
import ru.mikheev.kirill.hw13bank.logic.storage.CardNumberGeneratorGenerator;
import ru.mikheev.kirill.hw13bank.logic.storage.Generator;
import ru.mikheev.kirill.hw13bank.logic.storage.IdGenerator;
import ru.mikheev.kirill.hw13bank.logic.storage.PinGenerator;
...
public class User implements Transactional {
    ...
    private static final Generator<String> CARD_NUMBER_GENERATOR = new CardNumberGeneratorGenerator();
